...
INSERT INTO `payments` VALUES (1,320,_binary '0DßzN_°óªÛª\ÓW\·','2002-11-10','VISA',3),(2,320,_binary '0DßzN_°óªÛª\ÓW\·','2002-11-10','VISA',3),(3,320,_binary '0DßzN_°óªÛª\ÓW\·','2002-11-10','VISA',3);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `encrypt_cardno` BEFORE INSERT ON `payments` FOR EACH ROW BEGIN
 SET @encryption_key='my_secure_encryption_key';
 SET NEW.card_no=AES_ENCRYPT(NEW.card_no,@encryption_key);
 END */;;
DELIMITER ;
